...
//Mousemove / touchmove
genre_array = ["arcade-blocky", "casual-blocky", "fighting-blocky", "platform-blocky", "tower-blocky", "puzzle-blocky", "racing-blocky", "rpg-blocky", "sports-blocky", "strategy-blocky", "adventure-blocky",
...
$(document).on("click", ".bholder3", function(){
  ...
  if(current_underlinez == "fps-blocky9" || current_underlinez == "match 3-blocky9") {
...
// "fps-blocky", "tactics-blocky", "card-blocky", "sim-blocky", "pvp-blocky", "roguelike-blocky", "runner-blocky", "match-3-blocky"]
      ...
      if (diffX > 25) {
        ...
        if(clicked_genre_array+"9" == "fps-blocky9"){
          $(".horizontal-snap").scrollLeft(550);
        }
