...
<div class="glitch fade-in-left2" style="height: 175px; border: 2px solid;">
    ...
    fixy('glitchimg2')
     $(".yellowsplat").html(`
     <div class="leboxy123">
        <div class="leftboxy123"><img src="https://uploads-ssl.webflow.com/6262a56df551ed5332d9048e/63355e734fa11542f1cbd488_merge-stories-icon.png"> </div>

        <div class="rightboxy123"> 
        <h1 id="t1" class="heading-1609226612 move">Caterra: RPG Battle Royale</h1>
        <h2>Puzzle</h2>
        <h3>Trailer</h3>
        </div>
     </div>
...
if(the_id == "b4"){
 ...
 `)
  ...
  if(the_id == "b7"){
    fixy('glitchimg7')
  $(".yellowsplat").html(`
<h1 id="t1" class="heading-1609226612 move">Warcraft Arclight Rumble</h1><p id="p1" class="move">Warcraft Arclight Rumble is a mobile action strategy game where collectible Warcraft Minis come to life to clash in epic melee battles.</p>
`)
...
if(the_id == "b8"){
  ...
  $(".yellowsplat").html(`
<h1 id="t1" class="heading-1609226612 move">Dual Blader</h1><p id="p1" class="move">Dual blade has chosen you as a grand master.
Begin your journey as a dual blade master from High Garden to Lava Cliff, whipping the evil creatures for the justice.
</p>
`)
}
...
if(the_id == "b9"){
  ...
  $(".yellowsplat").html(`
<h1 id="t1" class="heading-1609226612 move">Harry Potter: Magic Awakened</h1><p id="p1" class="move">As a first year student, you will board the Hogwarts Express, meet many new classmates and friends, learn to cast spells, and experience fantastic times in the wizarding world.
</p>
`)
}
...
if(the_id == "b10"){
  ...
  $(".yellowsplat").html(`
<h1 id="t1" class="heading-1609226612 move">Kingdom Hunter</h1>
<p id="p1" class="move">
...
if(the_id == "b11"){
  ...
  $(".yellowsplat").html(`
<h1 id="t1" class="heading-1609226612 move">Rainbow Six Mobile</h1>
<p id="p1" class="move">
...
if(the_id == "b12"){
  ...
  $(".yellowsplat").html(`
<h1 id="t1" class="heading-1609226612 move">Dear, Ella</h1>
<p id="p1" class="move">
...
if(the_id == "b13"){
  ...
  $(".yellowsplat").html(`
<h1 id="t1" class="heading-1609226612 move">Time Raiders</h1>
<p id="p1" class="move">
...
if(the_id == "b14"){
  ...
  $(".yellowsplat").html(`
<h1 id="t1" class="heading-1609226612 move">Star Trek Lower Decks</h1>
<p id="p1" class="move">
...
if(the_id == "b15"){
  ...
  $(".yellowsplat").html(`
<h1 id="t1" class="heading-1609226612 move">Rent Please!-Landlord Sim</h1>
<p id="p1" class="move">
...
if(the_id == "b16"){
  ...
  $(".yellowsplat").html(`
<h1 id="t1" class="heading-1609226612 move">DC Heroes & Villains</h1>
<p id="p1" class="move">
...
if(the_id == "b17"){
    ...
    $(".yellowsplat").html(`
<h1 id="t1" class="heading-1609226612 move">Shop Heroes Legends</h1>
<p id="p1" class="move">
...
if(the_id == "b18"){
    ...
    $(".yellowsplat").html(`
<h1 id="t1" class="heading-1609226612 move">Iron Marines Invasion</h1>
<p id="p1" class="move">
...
if(the_id == "b19"){
    ...
    $(".yellowsplat").html(`
<h1 id="t1" class="heading-1609226612 move">Hungry for Home: A Cat's Tail</h1>
<p id="p1" class="move">
...
if(the_id == "b20"){
    fixy('glitchimg20')
    $(".yellowsplat").html(`
<h1 id="t1" class="heading-1609226612 move">Milk Farm Tycoon</h1>
<p id="p1" class="move">
...
if(the_id == "b21"){
    fixy('glitchimg21')
    $(".yellowsplat").html(`
<h1 id="t1" class="heading-1609226612 move">ZOMBIE Kingdom : Survival AFK</h1>
<p id="p1" class="move">
...
if(the_id == "b22"){
    fixy('glitchimg22')
    $(".yellowsplat").html(`
<h1 id="t1" class="heading-1609226612 move">Summoners War: Chronicles</h1>
<p id="p1" class="move">
...
if(the_id == "b23"){
    fixy('glitchimg23')
    $(".yellowsplat").html(`
<h1 id="t1" class="heading-1609226612 move">Design Blast - Match & Home</h1>
<p id="p1" class="move">
...
if(the_id == "b24"){
    fixy('glitchimg24')
    $(".yellowsplat").html(`
<h1 id="t1" class="heading-1609226612 move">ScourgeBringer</h1>
<p id="p1" class="move">
...
if(the_id == "b25"){
    fixy('glitchimg25')
    $(".yellowsplat").html(`
<h1 id="t1" class="heading-1609226612 move">KartRider: Drift</h1>
<p id="p1" class="move">
...
if(the_id == "b26"){
    fixy('glitchimg26')
    $(".yellowsplat").html(`
<h1 id="t1" class="heading-1609226612 move">Bear Bakery - Merge Tycoon</h1>
<p id="p1" class="move">
...
if(the_id == "b27"){
    fixy('glitchimg27')
    $(".yellowsplat").html(`
<h1 id="t1" class="heading-1609226612 move">MementoMori: AFKRPG</h1>
<p id="p1" class="move">
...
if(the_id == "b28"){
    fixy('glitchimg28')
    $(".yellowsplat").html(`
<h1 id="t1" class="heading-1609226612 move">Sniper Zombie 2</h1>
<p id="p1" class="move">
