...
function changeScore(colorz, numberz){
	$('.splash-score').css("display", 'block')
...
function changesplash(get_texty, divy) {
	...
	$(".special1").css("color", "black")
	$(".pp99").css("color", "black")
	$(".paragraph-40").css("color", "black")


	// Change font colors to white
	$(divy).find(".special1").css("color", "white")
	$(divy).find(".pp99").css("color", "black")
	$(divy).find(".paragraph-40").css("color", "black")
	...
	if(get_texty == "Diablo Immortal"){
		...
		$(divy).find(".special1").css("background", "red")
		...
		// Change background color depending on score
		$(divy).find(".special1").css("background", "purple")
		$(divy).find(".golong1").css("background", "transparent")

		$("#createVid").html(`
		<div class="glitch dasSize">
			<div class="glitch__item abc2"></div>
			<div class="glitch__item abc2"></div>
			<div class="glitch__item abc2"></div>
			<div class="glitch__item abc2"></div>
			<div class="glitch__item abc2"></div>
...
$(".latest-gamez").hover(function(){
    ...
    $(this).append('<div class="leBorder2" style="position: relative; top: -137px; left: -5px; width: 101px;"> <img src="https://uploads-ssl.webflow.com/6262a56df551ed5332d9048e/6364cf94037f1354c036742d_invis-block-2.png"> </div>');
