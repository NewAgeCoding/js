...
games = ["among us", "archero", "ancient planet tower defense", "art of war 3 global conflict", "cardinal quest 2", "baseball9", "altos adventure", "forge of empires", "mobile legends bang bang", "mushroom wars 2",
    "adventure beaks", "skullgirls", "alien isolation", "infinitode2", "nba 2k", "scary horror 2", "bloons td 6", "moonshades", "prison empire tycoon", "bloody bastards", "plague inc", "mini td 2", "defense legend 4", 
    ...
    "pba bowling challenge", "gunspell 2", "mortal crusade", "robot destroyer red siren", "angry birds 2", "election year knockout", "rocket league sideswipe", "sugar game", "that level again", "adventure beaks", "dino bash", "forest island", "hidden journey", "mad bullets", "diablo immortal"
]
...
$("input.fname-mobile[type='text']").on('input', function () {
    ...
    reset = reset + 1
    $("#removeHeading").css("display", "none")
    ...
    if (texty.length < 1) {
        $(".dropdownsearch").css("display", "none")
         $("#removeHeading").css("display", "block")
    }
...
// countdownT
var countDownDate2 = new Date("June 20, 2022 12:30:00").getTime();
...
//############################################
  ...
  baseLinkImg = "https://uploads-ssl.webflow.com/"
	...
	casual8b = new addGame(baseLinkReview+"walk-master", baseLinkImg+"6262a56df551ed5332d9048e/62827013ec9b21307b0c84d1_walk-master-icon.jpg", "Walk Master", "Physics")
		casual9b = new addGame(baseLinkReview+"sugar-game", baseLinkImg+"6262a56df551ed5332d9048e/62ac35b3deacb468440aee44_sugar-icon.jpg", "Walk Master", "")
	...
	casualTop8 = [casual4a, casual5a, puzzle5a, puzzle7a, puzzle8a]
	casualTop7 = [casual10b, casual9b, casual2a, casual1b, casual6a, casual2b, puzzle2a, casual3b, casual4b, casual5b, casual6b, casual7b, casual8b, puzzle1a, puzzle4a, puzzle1b, puzzle2b]
	...
	adventureTop7 = [simulation4a, action16a, adventure8a, adventure1a, adventure6a, adventure2a, adventure1b, action3b, action7b, action10b]
	...
	rpgTop6 = [rpg4c, rpg3c,rpg1c, rpg2c]
	...
	platformTop7 = [platform9a, platform7a, platform5a, platform2a, platform1a, platform2b, platform3b, platform4b, platform5b, platform6b]
	platformTop6 = [platform7c, platform1c, platform2c, platform3c, platform4c, platform5c, platform6c]
	...
	strategyTop8 = [strategy5a, strategy1a, strategy2a]
	strategyTop7 = [strategy4a, strategy1b, strategy2b, strategy3b]
	strategyTop6 = [strat8, strat7, strat6, strat4, strategy1c, strategy2c, simulation3c]
	...
	puzzleTop8 = [puzzle5a, puzzle7a, puzzle8a]
	...
	sportsTop7 = [sports5b, sports1a, sports2a, sports3a, sports4a, sports1b, sports2b, sports3b, sports4b]
...
if(pathname == "/mobile/casual-games") {
		...
		totalAction =  adventureTop7.length + adventureTop6.length
		$("#totalAction").text(totalAction)
		...
		totalAction = sportsTop7.length + sportsTop6.length
		$("#totalAction").text(totalAction)
