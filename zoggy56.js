...
$(document).on("click", ".bholder3", function(){
  $(this).removeClass("justbold")
  $(this).removeClass("underlinezzz")
  ...
  $(this).addClass("justbold")
  $(this).addClass("underlinezzz")
})
  ...
  if (isSwiped) {
    ...
    if (Math.abs(diffY) > Math.abs(diffX)) {
      ...
      if(diffX < -25) {
        ...
        $("#"+current_underlinez).addClass("justbold")
        $("#"+current_underlinez).addClass("underlinezzz")
        ...
        //$('.dastagz').animate( { scrollLeft: $("#"+clicked_genre_array).offset().left }, 50)
        // Scroll .dastagz hit puzzle
      //   if(clicked_genre_array == "racing-blocky") {
      //     $('.dastagz').animate( { scrollLeft: '+=300' }, 50);
      //   }

      //   // Scroll .dastagz hit adventure
      //   if(clicked_genre_array == "adventure-blocky") {
      //     $('.dastagz').animate( { scrollLeft: '+=220' }, 50);
      //   }
       
      // // Scroll .dastagz hit sim
      // if(clicked_genre_array == "sim-blocky") {
      //   $('.dastagz').animate( { scrollLeft: '+=220' }, 50);
      // }
      ...
      if (diffX > 25) {
       ...
       // $('.dastagz').animate( { scrollLeft: $("#"+clicked_genre_array).offset().left }, 50)
        // Scroll .dastagz hit puzzle
        // if(clicked_genre_array == "puzzle-blocky") {
        //   $('.dastagz').animate( { scrollLeft: '-=300' }, 50);
        // }

        // // Scroll .dastagz hit adventure
        //  if(clicked_genre_array == "strategy-blocky") {
        //   $('.dastagz').animate( { scrollLeft: '-=220' }, 50);
        // }
       
        // // Scroll .dastagz hit sim
        // if(clicked_genre_array == "card-blocky") {
        //   $('.dastagz').animate( { scrollLeft: '-=220' }, 50);
        // }
