...
//#################################
$(".profile").css("display", "none")
$(".profile").html(`<a href='https://jawsomegames.com/login/no_referal'>Google Login</a><BR><BR><a href='https://jawsomegames.com/twitter'>Twitter Login</a><BR><BR>
...
//##################################################
function changesplash(get_texty) {

	// Change its height to match original
	$("#createVid").css("height", "437px")
	...
	if(get_texty == "Diablo Immortal"){
		...
		// $("#createVid").html(`<img class="latimgz" src="https://uploads-ssl.webflow.com/6262a56df551ed5332d9048e/62658be9bbfa236eac0dc446_diablo-immortal-1.jpg">`)

		$("#createVid").html(`
		<div class="glitch dasSize">
			<div class="glitch__item abc1"></div>
			<div class="glitch__item abc1"></div>
			<div class="glitch__item abc1"></div>
			<div class="glitch__item abc1"></div>
			<div class="glitch__item abc1"></div>
		...
		// Score
		$('.splash-score').css("background", 'red')
		$('.splash-score').find('h3').text("6") 

	} else if(get_texty == "Sonic the Hedgehog"){
		$("#createVid").html(`<img class="latimgz" src="https://uploads-ssl.webflow.com/6262a56df551ed5332d9048e/6360c54b6855c98bba5e2c08_sonic-splash.jpg">`)
		$('.cta').attr("href", "https://www.androidshark.com/review/sonic-the-hedgehog-2-classic")

		// Score
		$('.splash-score').css("background", '#7716ff')
		$('.splash-score').find('h3').text("9") 
