  ...
  if(the_id == "b1"){
    fixy('glitchimg1')
        ...
        height: 200px;">
            ...
            <img class="move" src="https://uploads-ssl.webflow.com/6262a56df551ed5332d9048e/63355e734fa11542f1cbd488_merge-stories-icon.png" style="width: 100%">
        </div> 
            ...
            background: transparent;"> 
             ...
             <h3 class="fontzzzy3 move move">Watch Now ></h3>
    ...
    fixy('glitchimg2')
        ...
        height: 200px;">
            ...
            height: 100%;
            background: transparent;"> 
            <img class="move" src="https://uploads-ssl.webflow.com/6262a56df551ed5332d9048e/6335b128a24a7d80ceffd635_catera-icon.png" style="width: 100%">
        </div> 
            ...
            height: 100%;
            background: transparent;"> 
             <h1 id="t1" class=" move" class="fontzzzy" style="margin-top: 0;">Caterra</h1>
...
if(the_id == "b4"){
 ...
 height: 200px;">
     ...
     height: 100%;
     background: transparent;"> 
      <h1 id="t1" class=" move" class="fontzzzy" style="margin-top: 0;">Ready Heroes</h1>
      <h2 class="fontzzzy2 move">(Puzzle)</h2>
      <h3 class="fontzzzy3 move">Watch Now ></h3>
 ...
 height: 200px;">
     ...
     height: 100%;
     background: transparent;"> 
      <h1 id="t1" class=" move" class="fontzzzy" style="margin-top: 0;">Gunstars </h1>
      <h2 class="fontzzzy2 move">(Puzzle)</h2>
      <h3 class="fontzzzy3 move">Watch Now ></h3>
 ...
 height: 200px;">
     ...
     height: 100%;
     background: transparent;"> 
      <h1 id="t1" class=" move" class="fontzzzy" style="margin-top: 0;">One Punch Man </h1>
      <h2 class="fontzzzy2 move">(Puzzle)</h2>
      <h3 class="fontzzzy3 move">Watch Now ></h3>
...
height: 200px;">
    ...
    height: 100%;
    background: transparent;"> 
     <h1 id="t1" class=" move" class="fontzzzy" style="margin-top: 0;">Harry Potter</h1>
     <h2 class="fontzzzy2 move">(Puzzle)</h2>
     <h3 class="fontzzzy3 move">Watch Now ></h3>
...
height: 200px;">
    ...
    height: 100%;
    background: transparent;"> 
     <h1 id="t1" class=" move" class="fontzzzy" style="margin-top: 0;">Rent Please!</h1>
     <h2 class="fontzzzy2 move">(Puzzle)</h2>
     <h3 class="fontzzzy3 move">Watch Now ></h3>
...
height: 200px;">
    ...
    height: 100%;
    background: transparent;"> 
     <h1 id="t1" class=" move" class="fontzzzy" style="margin-top: 0;">Hungry for Home</h1>
     <h2 class="fontzzzy2 move">(Puzzle)</h2>
     <h3 class="fontzzzy3 move">Watch Now ></h3>
