...
// "fps-blocky", "tactics-blocky", "card-blocky", "sim-blocky", "pvp-blocky", "roguelike-blocky", "runner-blocky", "match-3-blocky"]
        ...
        if(clicked_genre_array+"9" == "racing-blocky9" || clicked_genre_array+"9" == "tactics-blocky9"){
      ...
      if (diffX > 25) {
        ...
        if(clicked_genre_array+"9" == "puzzle-blocky9" || clicked_genre_array+"9" == "fps-blocky9"){
          $(".horizontal-snap").scrollLeft(-550);
        }
