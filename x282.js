...
"skullgirls", "alien isolation", "infinitode2", "nba 2k", "scary horror 2", "bloons td 6", "moonshades", "prison empire tycoon", "bloody bastards", "plague inc", "mini td 2", "defense legend 4", 
    "badland", "battle of polytopia", "bee brilliant", "castle crush",  "exploding kittens", "raid shadow legends", "another eden", "naval storm", "rts siege up", "uniwar", "galaxy reavers",
    "the walking zombie 2", "lara croft relic run", "block puzzle", "asphalt 9 legends", "guardian tales", "plant the world", "square fists boxing", "brawlhalla", "mech arena robot showdown", "lost in blue", "life in adventure",
     "eternium", "fishdom", "gardenscapes", "good pizza great pizza", "grimvalor", "hellrider 3", "the king of fighters allstar",
    "hocus",  "moto x3m bike race game", "rooster defense", "botworld adventure", "street fighter iv champion edition",
     "nihilumbra", "onebit adventure",  "pirates showdown", "power rangers legacy wars", "great conqueror rome",
    "magic survival", "legend of solgard", "metal soldiers 2", "sky children of the light",  "space expedition", "genshin impact",
    "roblox", "shadow fight arena", "sky force reloaded", "snowman story", "life is strange", "death park 2", "forgotton anne",
    "stardew valley",  "tank battle heroes", "vampires fall origins", "fin ancient mystery", "oddmar",
    "jurassic monster world", "pubg mobile",  "mars mars", "kingdom rush", 
    ...
    "candy crush soda saga", "space marshals 2", "1945 air force", "snow bros classic", "golf king world tour", "hockey all stars","rival gears racing", "tsuki adventure", "grumpy dwarf", "hello yogurt", "air attack", "air attack 2",
     "age of magic", "basketball battle", "ancient bricks", "g switch 3", "johnny trigger",
      "mrbean special delivery", "ski safari 2", "transmute galaxy battle", "demolition derby 3", "temple run 2", "sword of xolan"
      , "sea invaders", "apple knight", "real racing 3", "constellation eleven", "xenowerk", "super cat tales 2", "lightning duru", "subway surfers", 
       "orbia", "carx highway racing",  "spongebob krusty cook off", "dragon mania legends", "cut the rope 2",
       "walk master", "okay", "endurance", "flaming-core", "simcity buildit", "snake arena", "leps world 3",  "megabots battle arena",
...
var countDownDate = new Date("August 28, 2022 21:00:00").getTime();
...
//############################################
  ...
  baseLinkImg = "https://uploads-ssl.webflow.com/"
	...
	casualTop8 = [puzzle7a]
	casualTop7 = [puzzle7a, casual12b, casual10b, casual9b, casual2a, casual1b, casual2b, puzzle2a, casual3b, casual4b, casual5b, casual6b, casual7b, casual8b,  puzzle4a, puzzle1b]
	...
	actionTop7 = [casual5a, action9a, action11a, action3a, action17a, action8a, action12a, action13a, action10a, action1a, action7a, puzzle3a, action2a, action4a, action1b, action4b, action5b, action8b, action9b, action11b, action15a]
	...
	// ADDING TO ACTION ARRAY
	fightTop8 = [action5a]
	fightTop7 = [fight3c, fight1a, action5a, fight2a, fight3a, fight4a]
	...
	adventureTop7 = [simulation4a, adventure1a, action16a, adventure8a, adventure6a, adventure2a, adventure1b, action3b, action7b, action10b]
	...
	rpgTop7 = [rpg5b, rpg9a, rpg4a, rpg7a, rpg5a, rpg6a, rpg8a, rpg3a, rpg10a, rpg2a, rpg1a, rpg1b, rpg2b,  rpg4b]
	...
	platformTop7 = [platform9a, platform5a, platform3a, platform2a, platform1a, platform4a, platform2b, platform6a, platform8a, platform3b, platform4b, platform6b]
	...
	strategyTop7 = [strategy7b, strategy6a, strategy7a, strategy4a, strategy1b, strategy5a, strategy2b, strategy1a, strategy3b, strategy2a]
	strategyTop6 = [strat9, strat8, strat7, strat6, strat4, strategy1c, strategy2c]
	...
	puzzleTop8 = [puzzle7a]
	puzzleTop7 = [puzzle4a, puzzle1b, puzzle7a]
	puzzleTop6 = [puzzle1c]
	...
	racingTop8 = [racing7a]
	racingTop7 = [racing6a, racing1a, racing3a, racing1b, racing2b, racing7a, racing3b]
	...
	simulationTop7 = [simulation5a, simulation2b, simulation2a, simulation3a, simulation3b, simulation4b]
	simulationTop6 = [simulation5c, simulation2c, simulation4c]
	...
	sportsTop8 = [sports4a]
	sportsTop7 = [sports5b, sports1a, sports2a, sports3a, sports4a, sports1b, sports3b, sports4b]
	...
	tdTop7 = [td2b, td1b, td4a, td1a, td3a, td2a]
	tdTop6 = [td5c, td1c, td2c, td6c]
	
	
	alltop8s = ["Orbia", "Archero", "Grimvalor" , "Brawlhalla", "Alien Isolation", "Eternium", "Guardian Tales", "Sky Children", "Another Eden", "Nihilumbra", "Oddmar", "Sword of Xolan", "Forgotton Anne", "Teamfight Tactics",
		"Mobile Legends", "Art of War 3", "Battle of Polytopia", "Not Not", "Real Racing 3", "Good Pizza", "Stardew Valley", "World of Tennis", "Kingdom Rush", "Ancient Planet", "Bloons TD 6"]
  ...
  function addGamesAll(theGameName) {   
    ...
    $(eval(theGameName7)).each(function(index, value) {
		...
		if($.inArray( value.name, alltop8s) != -1) {
			console.log("is in array", value.name);
			$(".greenGames").append(`
			<div class="menuGameBoxes">
			<a href=${value.aLink}  style="position:relative; z-index:5">
			<div><img src=${value.img} loading="lazy"></div>
			...
			<div class="menuGamesBoxP">
			<span style="color:purple; font-weight:bold;">${value.name}</span>
		   <div class="menuGamesBoxP" style="color:grey;">${value.mini}</div>
			</div>
			  </div>
			`)
...
// 	$("#c1").removeClass("circleon")
// 	$("#c2").removeClass("circleon")
// 	$("#c3").removeClass("circleon")
// 	$(this).addClass("circleon")
// 	$("#a1").text("Bobby Blabby")
// 	$("#a2").text("20 July, 2022")
// 	$("#a3").text("Lorem ipsum dolor sit amet, consectetur adiptristique posuere.")
// })
...
// 	$(this).addClass("circleon")
// 	$("#a1").text("Lumpus")
// 	$("#a2").text("10 August, 2022")
// 	$("#a3").text("Lorem ipsum dolor sit amet, casdasdasdasd adiptristique posuere.")
// })
...
// 	$(this).addClass("circleon")
// 	$("#a1").text("Slinkman")
// 	$("#a2").text("10 February, 2022")
// 	$("#a3").text("Lorem ipsum dolor sit amet, zzzzzz.")
// })


// $(document).on("click", "#newgame2btn1", function(){
// 	$("#newgame2btn1").removeClass("circleon")
// 	$("#newgame2btn2").removeClass("circleon")
// 	$("#newgame2btn3").removeClass("circleon")
// 	$(this).addClass("circleon")
// 	$("#newgame2name").text("Bobby Blabby222")
// 	$("#newgame2date").text("20 July, 2022")
// 	$("#newgame2content").text("Lorem ipsum dolor sit amet, consectetur adiptristique posuere.")
// })

// $(document).on("click", "#newgame2btn2", function(){
// 	$("#newgame2btn1").removeClass("circleon")
// 	$("#newgame2btn2").removeClass("circleon")
// 	$("#newgame2btn3").removeClass("circleon")
// 	$(this).addClass("circleon")
// 	$("#newgame2name").text("Lumpus222")
// 	$("#newgame2date").text("10 August, 2022")
// 	$("#newgame2content").text("Lorem ipsum dolor sit amet, casdasdasdasd adiptristique posuere.")
// })

// $(document).on("click", "#newgame2btn3", function(){
// 	$("#newgame2btn1").removeClass("circleon")
// 	$("#newgame2btn2").removeClass("circleon")
// 	$("#newgame2btn3").removeClass("circleon")
// 	$(this).addClass("circleon")
// 	$("#newgame2name").text("Slinkman222")
// 	$("#newgame2date").text("10 February, 2022")
// 	$("#newgame2content").text("Lorem ipsum dolor sit amet, zzzzzz.")
// })



// $(document).on("click", "#newgame3btn1", function(){
// 	$("#newgame3btn1").removeClass("circleon")
// 	$("#newgame3btn2").removeClass("circleon")
// 	$("#newgame3btn3").removeClass("circleon")
// 	$(this).addClass("circleon")
// 	$("#newgame3name").text("Bobby Blabby333")
// 	$("#newgame3date").text("20 July, 2022")
// 	$("#newgame3content").text("Lorem ip3sum dolor sit amet, consectetur adiptristique posuere.")
// })

// $(document).on("click", "#newgame3btn2", function(){
// 	$("#newgame3btn1").removeClass("circleon")
// 	$("#newgame3btn2").removeClass("circleon")
// 	$("#newgame3btn3").removeClass("circleon")
// 	$(this).addClass("circleon")
// 	$("#newgame3name").text("Lumpus332")
// 	$("#newgame3date").text("10 August, 2022")
// 	$("#newgame3content").text("Lorem 3 ipsum dolor sit amet, casdasdasdasd adiptristique posuere.")
// })

// $(document).on("click", "#newgame3btn3", function(){
// 	$("#newgame3btn1").removeClass("circleon")
// 	$("#newgame3btn2").removeClass("circleon")
// 	$("#newgame3btn3").removeClass("circleon")
// 	$(this).addClass("circleon")
// 	$("#newgame3name").text("Slinkman332")
// 	$("#newgame3date").text("10 February, 2022")
// 	$("#newgame3content").text("Lorem 3 ipsum dolor sit amet, zzzzzz.")
// })
