...
<div class="glitch fade-in-left2" style="height: 175px; border: 2px solid;">
    ...
    fixy('glitchimg2')
        ...
        height: 200px;">
            ...
            height: 100%;
            background: transparent;"> 
             <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">Caterra: RPG Battle Royale</h1>
             <h2 class="fontzzzy2">Puzzle</h2>
             <h3 class="fontzzzy3">Trailer</h3>
 ...
 height: 200px;">
     ...
     height: 100%;
     background: transparent;"> 
      <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">Minion Masters</h1>
      <h2 class="fontzzzy2">Puzzle</h2>
      <h3 class="fontzzzy3">Trailer</h3>
...
if(the_id == "b4"){
 ...
 height: 200px;">
     ...
     height: 100%;
     background: transparent;"> 
      <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">Ready Heroes: Nirvana Hun</h1>
      <h2 class="fontzzzy2">Puzzle</h2>
      <h3 class="fontzzzy3">Trailer</h3>
 ...
 height: 200px;">
     ...
     height: 100%;
     background: transparent;"> 
      <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">Gunstars - Battle Royale</h1>
      <h2 class="fontzzzy2">Puzzle</h2>
      <h3 class="fontzzzy3">Trailer</h3>
 ...
 height: 200px;">
     ...
     height: 100%;
     background: transparent;"> 
      <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">One Punch Man - The Strongest</h1>
      <h2 class="fontzzzy2">Puzzle</h2>
      <h3 class="fontzzzy3">Trailer</h3>
...
height: 200px;">
    ...
    height: 100%;
    background: transparent;"> 
     <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">Warcraft Arclight Rumble</h1>
     <h2 class="fontzzzy2">Puzzle</h2>
     <h3 class="fontzzzy3">Trailer</h3>
...
height: 200px;">
    ...
    height: 100%;
    background: transparent;"> 
     <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">Dual Blader</h1>
     <h2 class="fontzzzy2">Puzzle</h2>
     <h3 class="fontzzzy3">Trailer</h3>
...
height: 200px;">
    ...
    height: 100%;
    background: transparent;"> 
     <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">Harry Potter: Magic Awakened</h1>
     <h2 class="fontzzzy2">Puzzle</h2>
     <h3 class="fontzzzy3">Trailer</h3>
...
height: 200px;">
    ...
    height: 100%;
    background: transparent;"> 
     <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">Kingdom Hunter</h1>
     <h2 class="fontzzzy2">Puzzle</h2>
     <h3 class="fontzzzy3">Trailer</h3>
...
height: 200px;">
    ...
    height: 100%;
    background: transparent;"> 
     <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">Rainbow Six Mobile</h1>
     <h2 class="fontzzzy2">Puzzle</h2>
     <h3 class="fontzzzy3">Trailer</h3>
...
height: 200px;">
    ...
    height: 100%;
    background: transparent;"> 
     <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">Dear, Ella</h1>
     <h2 class="fontzzzy2">Puzzle</h2>
     <h3 class="fontzzzy3">Trailer</h3>
...
height: 200px;">
    ...
    height: 100%;
    background: transparent;"> 
     <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">Time Raiders</h1>
     <h2 class="fontzzzy2">Puzzle</h2>
     <h3 class="fontzzzy3">Trailer</h3>
...
height: 200px;">
    ...
    height: 100%;
    background: transparent;"> 
     <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">Star Trek Lower Decks</h1>
     <h2 class="fontzzzy2">Puzzle</h2>
     <h3 class="fontzzzy3">Trailer</h3>
...
height: 200px;">
    ...
    height: 100%;
    background: transparent;"> 
     <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">Rent Please!-Landlord Sim</h1>
     <h2 class="fontzzzy2">Puzzle</h2>
     <h3 class="fontzzzy3">Trailer</h3>
...
height: 200px;">
    ...
    height: 100%;
    background: transparent;"> 
     <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">DC Heroes & Villains</h1>
     <h2 class="fontzzzy2">Puzzle</h2>
     <h3 class="fontzzzy3">Trailer</h3>
...
height: 200px;">
    ...
    height: 100%;
    background: transparent;"> 
     <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">Shop Heroes Legends</h1>
     <h2 class="fontzzzy2">Puzzle</h2>
     <h3 class="fontzzzy3">Trailer</h3>
...
height: 200px;">
    ...
    height: 100%;
    background: transparent;"> 
     <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">Iron Marines Invasion</h1>
     <h2 class="fontzzzy2">Puzzle</h2>
     <h3 class="fontzzzy3">Trailer</h3>
...
height: 200px;">
    ...
    height: 100%;
    background: transparent;"> 
     <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">Hungry for Home: A Cat's Tail</h1>
     <h2 class="fontzzzy2">Puzzle</h2>
     <h3 class="fontzzzy3">Trailer</h3>
...
height: 200px;">
    ...
    height: 100%;
    background: transparent;"> 
     <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">Milk Farm Tycoon</h1>
     <h2 class="fontzzzy2">Puzzle</h2>
     <h3 class="fontzzzy3">Trailer</h3>
...
height: 200px;">
    ...
    height: 100%;
    background: transparent;"> 
     <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">ZOMBIE Kingdom : Survival AFK</h1>
     <h2 class="fontzzzy2">Puzzle</h2>
     <h3 class="fontzzzy3">Trailer</h3>
...
height: 200px;">
    ...
    height: 100%;
    background: transparent;"> 
     <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">Summoners War: Chronicles</h1>
     <h2 class="fontzzzy2">Puzzle</h2>
     <h3 class="fontzzzy3">Trailer</h3>
...
height: 200px;">
    ...
    height: 100%;
    background: transparent;"> 
     <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">Design Blast - Match & Home</h1>
     <h2 class="fontzzzy2">Puzzle</h2>
     <h3 class="fontzzzy3">Trailer</h3>
...
height: 200px;">
    ...
    height: 100%;
    background: transparent;"> 
     <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">ScourgeBringer</h1>
     <h2 class="fontzzzy2">Puzzle</h2>
     <h3 class="fontzzzy3">Trailer</h3>
...
height: 200px;">
    ...
    height: 100%;
    background: transparent;"> 
     <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">KartRider: Drift</h1>
     <h2 class="fontzzzy2">Puzzle</h2>
     <h3 class="fontzzzy3">Trailer</h3>
...
height: 200px;">
    ...
    height: 100%;
    background: transparent;"> 
     <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">Bear Bakery - Merge Tycoon</h1>
     <h2 class="fontzzzy2">Puzzle</h2>
     <h3 class="fontzzzy3">Trailer</h3>
...
height: 200px;">
    ...
    height: 100%;
    background: transparent;"> 
     <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">MementoMori: AFKRPG</h1>
     <h2 class="fontzzzy2">Puzzle</h2>
     <h3 class="fontzzzy3">Trailer</h3>
...
height: 200px;">
    ...
    height: 100%;
    background: transparent;"> 
     <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">Sniper Zombie 2</h1>
     <h2 class="fontzzzy2">Puzzle</h2>
     <h3 class="fontzzzy3">Trailer</h3>
...
if(the_id == "b29"){
    fixy('glitchimg29')
    $(".yellowsplat").html(`
<h1 id="t1" class="heading-1609226612 move">Last War: Shelter Heroes</h1>
<p id="p1" class="move">
...
height: 200px;">
    ...
    height: 100%;
    background: transparent;"> 
     <h1 id="t1" class="heading-1609226612 move" class="fontzzzy" style="margin-top: 0;">Last War: Shelter Heroes</h1>
     <h2 class="fontzzzy2">Puzzle</h2>
     <h3 class="fontzzzy3">Trailer</h3>
