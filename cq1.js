...
$(document).on("click", ".mag-glass12", function(){
  $(".part01").css("display", "none")
  $(".part02").css("display", "block")
  $(".searchpart1").css("display", "block")
  $(".sss3").val("")
  $(".search-texty").css("display", "block")
  $(".searchplaceholder-2").css("display", "block")
})
...
$(document).on("click", ".click_news", function(){
  ...
  $(".click_news2").css("text-underline-position", "under")
  $(".genre-tab-update1").find("h4").removeClass("underlinezzz")

  $('.genre-tab-update1').each(function(i, obj) {
      a = $(this).find("h4").hasClass("hvr-underline-from-left")
      if(a == false) {
        $(this).find("h4").addClass("hvr-underline-from-left")
      }
  });
})


$(document).on("click", ".sss3", function(){
	$(".search-texty").css("display", "none")
  $(".searchplaceholder-2").css("display", "none")
})
