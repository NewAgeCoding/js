...
"skullgirls", "alien isolation", "infinitode2", "nba 2k", "scary horror 2", "bloons td 6", "moonshades", "prison empire tycoon", "bloody bastards", "plague inc", "mini td 2", "defense legend 4", 'grand mountain adventure',
    ...
    "candy crush soda saga", "space marshals 2", "1945 air force", "snow bros classic", "golf king world tour", "hockey all stars","rival gears racing",  "grumpy dwarf", "hello yogurt", "air attack", "air attack 2",
     "age of magic", "basketball battle",  "g switch 3", "johnny trigger", "touchgrind bmx 2", "ski safari 2", 
      ...
      , "sea invaders", "apple knight", "real racing 3", "constellation eleven", "xenowerk", "super cat tales 2", "lightning duru", "subway surfers", 
       "orbia", "carx highway racing",  "dragon mania legends", "snake arena", "bee brilliant", "hill climb racing 2",
...
//############################################
  ...
  baseLinkImg = "https://uploads-ssl.webflow.com/"
	...
	casualTop8 = [casual2a, simulation2a]
	casualTop7 = [casual8b, casual2a, casual5b, simulation2a, casual12b, casual2b, puzzle2a, casual4b, casual6b]
	...
	actionTop7 = [action9b, casual5a, action9a, action11a, action3a, action17a, action8a, action13a, action1a, action7a, puzzle3a, action2a, action4a, action1b, action4b, action5b, action8b, action11b, action15a]

	actionTop6 = [action1c, action2c, action3c, action4c, action5c, action7c, puzzle2c]


	// ADDING TO FIGHTING ARRAY
	fightTop8 = [fight3a, action5a]
	...
	racingTop7 = [racing4a, racing2a, racing6a, racing1a, racing3a, racing1b, racing7a, racing3b]
...
$(document).on("click", ".sharez", function(){
	...
	if(str1 == "https://www.androidshark.com/latest-mobile-game-reviews" || "https://www.androidshark.com/latest-test") {
		str1 = "blahblah"
	}
	var str2 = 'review'
...
$.get("https://jawsomegames.com/latest-poll", function(data, status){
  ...
  q2 = myArray[1]
  total = q1 + q2
  percentage_q1 = (q1 / total) * 100
  percentage_q2 = (q2 / total) * 100
  ...
  if(did_vote2 == current_poll_number) {
    ...
    barz = `
      <div class="fp1" style=width:${percentage_q1}; height:30px; background-color:red">${q1} votes. ${percentage_q1}</div> <BR><BR>
      <div class="fp2" style=width:${percentage_q2}; height:30px; background-color:red">${q2} votes. ${percentage_q2}</div> <BR><BR>
