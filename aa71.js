...
"skullgirls", "alien isolation", "infinitode2", "nba 2k", "scary horror 2", "bloons td 6", "moonshades", "prison empire tycoon", "bloody bastards", "plague inc", "mini td 2", "defense legend 4", 'grand mountain adventure',
    ...
    "candy crush soda saga", "space marshals 2", "1945 air force", "snow bros classic", "golf king world tour", "hockey all stars","rival gears racing",  "grumpy dwarf", "hello yogurt", "air attack", "air attack 2",
     "age of magic", "basketball battle",  "g switch 3", "johnny trigger", "touchgrind bmx 2", "ski safari 2", 
      "transmute galaxy battle", "demolition derby 3", "sword of xolan", "horizon chase world tour"
      , "sea invaders", "apple knight", "real racing 3", "constellation eleven", "xenowerk", "super cat tales 2", "lightning duru", "subway surfers", 
       "orbia", "carx highway racing",  "dragon mania legends", "snake arena", "hill climb racing 2",
       "walk master",  "endurance", "flaming-core", "simcity buildit",  "leps world 3",  "megabots battle arena",
...
$(".profile").html("<a href='https://jawsomegames.com/login/no_referal'>Login</a>")
$(".makesugg").css("display", "none")
          ...
          <a href="${value.urlz}">
            ...
            <div class="info1">
				...
				<div class="slotsss1">
					...
					<div class="game-name" style="float:left; margin-left: 22px;"><h2>${resultz}</h2></div>
					<div class="genre-name" style="float:left;"><h3>${value.genre}</h3></div>
...
for (let i = 0; i < 20; i++) {
	...
	if(does_it_exist){
		if(does_it_exist == "1"){
			...
			$("#"+vote_id).find(".heart").toggleClass("is-active");
...
$(document).on("click", ".heart", function(){
	...
	if(allClass[1] == 'no-click' || allClass[1] == 'is-active'){
