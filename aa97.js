  ...
  function addGamesAll(theGameName) {   
    ...
    $(eval(theGameName7)).each(function(index, value) {
      ...
      if($.inArray( value.aLink, listy) != -1) {
        ...
        <div class="menuGamesBoxP">
        <span style="color:purple; font-weight:normal;">${value.name}</span>
         <div class="menuGamesBoxP" style="color:grey;">${value.mini}</div>
        </div>
      ...
      le_daat = compareDatez(le_daat, gg)
        ...
        $(".mystats").html(
          `
		   ...
		   Completed reviews: ${total_len_read_games} <BR>
...
if(get_recent_games) {
  $.each( get_recent_games.reverse(), function( key, value ) {
      game_name = key
...
if(get_bookmarks) {
  ...
  margin-top: 7px;"><h3>(Casual)</h3></div>
			  ...
			  <div class="picz1">
				  <img src="https://uploads-ssl.webflow.com/626305d92309c16f65ff1358/626781870192cb7f490b704f_bee-brilliant-splash.jpg">
			  </div>
