...
$.get("https://jawsomegames.com/latest-poll", function(data, status){
  ...
  if(did_vote2 == current_poll_number) {
    ...
    barz = `
      <div class="fp1" style="width:${percentage_q1}%; height:20px; background-color:red"></div> <BR>${q1} votes. ${percentage_q1}<BR>
      <div class="fp2" style="width:${percentage_q2}%; height:20px; background-color:red"></div> <BR>${q2} votes. ${percentage_q2}<BR>
