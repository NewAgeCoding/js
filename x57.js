...
//   $("#all-pop-up-genre").css("display", "block")
	mobileTop8 = `
		<div class="purpleBlock777">
			...
			color: #fff;
			font-size: 15px;
			text-align: center;">Excellently Polished</div>

			<div class="purpleGames" style="margin-top: 10px;
			margin-bottom: 20px;">aa</div>
		</div>
	`

	mobileTop7 = `
		<div class="greenBlock777">
			<div class="longLine99"></div>
			...
			color: #fff;
			font-size: 15px;
			text-align: center;">Worth Playing</div>
	...
	mobileTop6 = `
		<div class="redBlock777">
			...
			color: #fff;
			font-size: 15px;
			text-align: center;">Average: ≤ 6</div>
