...
// ##################################################################
piccc = {
    0: `<img style="width:110px;" src="https://uploads-ssl.webflow.com/6262a56df551ed5332d9048e/630771aeb6555d5c593940af_babyshark.png">`,
    
    1: `<img style="width:110px;" src='https://uploads-ssl.webflow.com/6262a56df551ed5332d9048e/62b067cecb2d9a517f6cf19f_Spike.png'>`
  }
...
"skullgirls", "alien isolation", "infinitode2", "nba 2k", "scary horror 2", "bloons td 6", "moonshades", "prison empire tycoon", "bloody bastards", "plague inc", "mini td 2", "defense legend 4", 
    ...
    "hocus",  "moto x3m bike race game", "rooster defense", "botworld adventure", "street fighter iv champion edition",
     "nihilumbra",  "pirates showdown", "power rangers legacy wars", "great conqueror rome", 'cosmic challenge racing',
    "magic survival", "legend of solgard", "metal soldiers 2", "sky children of the light",  "genshin impact",
    "roblox", "shadow fight arena",  "snowman story", "life is strange", "death park 2", "forgotton anne",
    "stardew valley",  "tank battle heroes", "vampires fall origins", "fin ancient mystery", "oddmar",
    "jurassic monster world", "pubg mobile",  "mars mars", "kingdom rush", 'cube escape paradox',
    ...
    "candy crush soda saga", "space marshals 2", "1945 air force", "snow bros classic", "golf king world tour", "hockey all stars","rival gears racing",  "grumpy dwarf", "hello yogurt", "air attack", "air attack 2",
     "age of magic", "basketball battle",  "g switch 3", "johnny trigger",
      "mrbean special delivery", "transmute galaxy battle", "demolition derby 3", "sword of xolan"
      , "sea invaders", "apple knight", "real racing 3", "constellation eleven", "xenowerk", "super cat tales 2", "lightning duru", "subway surfers", 
       "orbia", "carx highway racing",  "dragon mania legends", 
       "walk master",  "endurance", "flaming-core", "simcity buildit", "snake arena", "leps world 3",  "megabots battle arena",
        "earn 2 die", "not not", "rail rush", "fancy pants adventures", "kung fu fight arena", "payback 2", "plank", "sky fighters 3d", "stick war legacy",
         "the frostrune", "real boxing 2", "world of tennis roaring 20s", "bowmasters",  "module td", "32 secs",
...
var countDownDate = new Date("September 28, 2022 21:00:00").getTime();
...
//############################################
  ...
  baseLinkImg = "https://uploads-ssl.webflow.com/"
	...
	casualTop8 = [simulation2a]
	casualTop7 = [simulation2a, casual12b, casual2a, casual2b, puzzle2a, casual4b, casual5b, casual6b, casual8b]
	casualTop6 = [simulation5c, casual5c, casual1c, casual2c]


	// ADDING TO ACTION ARRAY
	actionTop8 = [casual5a, action3a, action8a]

	actionTop7 = [casual5a, action9a, action11a, action3a, action17a, action8a, action13a, action1a, action7a, puzzle3a, action2a, action4a, action1b, action4b, action5b, action8b, action11b, action15a]
	...
	rpgTop7 = [simulation3a, rpg5b, rpg9a, rpg4a, rpg5a, rpg6a, rpg8a, rpg3a, rpg10a, rpg2a, rpg1a, rpg1b, rpg2b,  rpg4b]
	...
	platformTop7 = [platform5a, platform3a, platform2a, platform1a, platform4a, platform6a, platform8a, platform3b, platform4b, platform6b]
	platformTop6 = [platform7c, platform2c, platform3c, platform4c, platform5c, platform6c]

	// ADDING TO STRATEGY ARRAY
	strategyTop8 = [simulation5a, strategy7a, strategy5a, strategy1a, strategy2a]
	strategyTop7 = [simulation5a, simulation3b, simulation2b, strategy7b, strategy6a, strategy7a, strategy4a, strategy1b, strategy5a, strategy2b, strategy1a, strategy3b, strategy2a]
	strategyTop6 = [strategy1c, simulation2c, strat9, strat8, strat7, strat6, strat4, strategy1c, strategy2c]


	
	// ADDING TO PUZZLE ARRAY
	simulationTop8 = [puzzle7a, puzzle4a]
	simulationTop7 = [puzzle1a, casual9b, casual10b, puzzle7a, puzzle4a ]
	simulationTop6 = [casual4c]


	// ADDING TO racing ARRAY
	racingTop8 = [racing2a, racing7a]
	racingTop7 = [racing2a, racing6a, racing1a, racing3a, racing1b, racing2b, racing7a, racing3b]
...
$(document).on("click", ".sharez", function(){
	...
	if(str1 == "https://www.androidshark.com/latest-mobile-game-reviews") {
		str1 = "blahblah"
	}
	var str2 = 'review'
       ...
       if(data == 'dun') {
        console.log("SEND ITTTTT2")
       	$(".suggestbox").css("display", "none")
            ...
            stringz = `
            <h3>${suggest}</h3><p>${suggestarea}</p>
            <img src=piccc[${daspic}] style="width:59px;">
