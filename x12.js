...
class Newz {
  constructor(name, img, blueBlock, desc, linkz) {
    this.name = name;
   	this.img = img;
...
allNewzItems = [n1, n2, n3, n4, n5, n6, n7, n8, n9]
...
allNewzItems.forEach(function (item, v) {
	headz = `<h3 style="font-size:17px; line-height: 23px;">${item.name}</h3>`
	dasImg = `<a href='${item.linkz}'><img src=${item.img} style="width:343px; height:161px; object-fit: cover;"></a>`
	...
	dasP = `<p style="margin-bottom:40px;">${item.desc}</p>`
	$(".allarticles").append("<div style='margin-bottom:15px;'>" + headz + dasImg + dasGenre + dasP + "</div>")
});
