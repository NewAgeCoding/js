  ...
  $.each( get_bookmarks, function( key, value ) {
      ...
      <div class="entirebox1">
          ...
          <a href="${value.urlz}">
            ...
            <div class="info1">
                <div class="game-name"><h2>${value.game_name}</h2></div>
                <div class="genre-name"><h3>${value.genre}</h3></div>
                <div class="scorereviewblock shadow" style="width: 35px; height:35px; float: left; background-color: rgb(9, 245, 9);"><h3 class="heading-118" style="font-size: 23px;
                color: white;
