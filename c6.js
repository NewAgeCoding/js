  ...
  function addGamesAll(theGameName) {   
    ...
    try {
		...
		<img src="https://uploads-ssl.webflow.com/6262a56df551ed5332d9048e/63145337482ba73547779521_starz.png">
      	...
      	${value.name} taaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
     	<div class="menuGamesBoxP" style="color:red;">${value.mini} raaaa</div>
      	</div>
        </div>
      `)
    });
    ...
    $(eval(theGameName7)).each(function(index, value) {
      ...
      if($.inArray( value.aLink, listy2) != -1) {
        ...
        <div>
		<img src=${value.img} loading="lazy">
		<img src="https://uploads-ssl.webflow.com/6262a56df551ed5332d9048e/63145337482ba73547779521_starz.png" style="    position: absolute;
		width: 13px;
		left: -28px;
		top: 3px;">
