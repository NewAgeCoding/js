...
$(document).on("click", ".link-22", function(){
	...
	$(".purpleBlock777").css("top", "47px")
	$(".greenBlock777").css("top", "47px")
	$(".redBlock777").css("top", "47px")
	...
	//   $("#all-pop-up-genre").css("display", "block")
		...
		mobileTop8 = `
			...
			align-items: left;">
				...
				<h4 class= "ff1 r1" style="    position: relative;
				top: 31px;
				color: white;
				z-index: 2;
				font-size: 13px;
				font-family: lato;
				text-align: center;
				width: 170px;">Excellently Polished</h4>
		...
		mobileTop7 = `
			...
			align-items: left;">
				...
				<h4 class= "ff1 r2" style="    position: relative;
				top: 31px;
				color: white;
				z-index: 2;
				font-size: 13px;
		...
		mobileTop6 = `
			...
			<h4 class= "ff1 r3" style="    position: relative;
			top: 31px;
			color: white;
			z-index: 2;
			font-size: 13px;
