...
//############################################
  ...
  baseLinkImg = "https://uploads-ssl.webflow.com/"
	...
	casualTop8 = [casual2a, casual4a, casual5a]
	casualTop7 = [casual1b, casual2a, casual2b, casual6a, casual3b, casual4b, casual5b, casual6b, casual7b, casual8b]
	...
	actionTop8 = [action3a, action5a, action8a]

	actionTop7 = [action1b, action3b, action4b, action5b, action1a, action2a, action4a, 
				action7b, action7a, action8b, action9b, action10b, action11b,
				action9a, action10a, action11a, action12a, action13a,
				action15a, action16a, action17a]
	...
	// ADDING TO ACTION ARRAY
	fightTop7 = [fight1a, fight2a, fight3a, fight4a]
	...
	adventureTop7 = [adventure1b, adventure1a, adventure2a, adventure6a, adventure8a]
	...
	// ADDING TO RPG ARRAY
	rpgTop8 = [rpg4a, rpg5a, rpg8a]
	rpgTop7 = [rpg1b, rpg2b, rpg3b, rpg4b, rpg1a, rpg2a, rpg3a, rpg6a, rpg7a, rpg9a]
	rpgTop6 = [rpg1c, rpg2c]
	...
	platformTop7 = [platform1a, platform2a, platform5a, platform7a, platform9a, platform2b, platform3b, platform4b, platform5b, platform6b]
	...
	strategyTop8 = [strategy1a]
	strategyTop7 = [strategy1b, strategy2b, strategy3b, strategy2a, strategy4a]
	...
	puzzleTop7 = [puzzle1b, puzzle2b, puzzle1a, puzzle2a, puzzle3a, puzzle4a]
	...
	racingTop7 = [racing1b, racing2b, racing3b, racing4b,racing1a, racing2a, racing3a, racing4a, racing6a]
	...
	simulationTop7 = [simulation1b, simulation2b, simulation3b, simulation4b, simulation1a, simulation4a]
	...
	sportsTop7 = [sports1b, sports2b, sports3b, sports4b, sports1a, sports2a, sports3a, sports4a]
...
if(pathname == "/mobile/casual-games") {
		...
		addGamesAllPC("fight")
		totalAction = fightTop7.length  + fightTop6.length
		$("#totalAction").text(totalAction)
