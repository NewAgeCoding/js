...
$(document).on("click", ".sharez", function(){
    ...
    console.log(getID, suggest, suggestarea)
  	$.post("https://jawsomegames.com/suggest",  {getID: getID, suggest: suggest, suggestarea: suggestarea}, function(data, status){
       if(data == 'dun') {
       	$(".suggestbox").css("display", "none")
        	$(".mecomment").html("")
          stringz = `<h3>${suggest}</h3><p>${suggestarea}</p><div style="float:right">Comment pending</div>`
