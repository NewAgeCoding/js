...
"skullgirls", "alien isolation", "infinitode2", "nba 2k", "scary horror 2", "bloons td 6", "moonshades", "prison empire tycoon", "bloody bastards", "plague inc", "mini td 2", "defense legend 4", 'grand mountain adventure',
    ...
    "candy crush soda saga", "space marshals 2", "1945 air force", "snow bros classic", "golf king world tour", "hockey all stars","rival gears racing",  "grumpy dwarf", "hello yogurt", "air attack", "air attack 2",
     "age of magic", "basketball battle",  "g switch 3", "johnny trigger", "touchgrind bmx 2",
...
//############################################
  ...
  baseLinkImg = "https://uploads-ssl.webflow.com/"
	...
	casualTop6 = [farmville3, gordonramsaychefblast, simulation5c, casual5c, casual1c, casual2c]
  ...
  function addGamesAll(theGameName) {   
    ...
    $(eval(theGameName7)).each(function(index, value) {
      ...
      // is it a read game
      if($.inArray( value.aLink, listy) != -1) {
        $(".greenGames").append(`
        <div class="menuGameBoxes">
        <a href=${value.aLink}  style="position:relative; z-index:5">
        <div><img src=${value.img} loading="lazy"></div>
        ...
        <div class="greent2"> <img src="https://uploads-ssl.webflow.com/6262a56df551ed5332d9048e/633ad8a7b5d7fa7110f20b10_tickgreen.png"> </div>
          </div>
        `)
      } else {
        $(".greenGames").append(`
...
function showGames(genre, thisb){
    ...
    <input type="checkbox" id="readz" name="readz" value="readz">
      ...
      top: -14px;
      left: -80px;
      font-weight: normal;">Mark as read</h4>
...
$(document).on("click", ".menuGameBoxes a", function(e){
  if(mark_game == 'true'){
    ...
    console.log("GET", get_read_games)
    ...
    if(get_read_games){
      ...
      arr = []
      arr.push(get_link)
      console.log(arr, get_link)
      stringzz = JSON.stringify(arr)
      localStorage.setItem('readgames', stringzz)
    }

    // Add green tick over image
    $(this).append('<div class="greent1"> <img src="https://uploads-ssl.webflow.com/6262a56df551ed5332d9048e/633ad8a7b5d7fa7110f20b10_tickgreen.png"> </div>')
    e.preventDefault();
  }
 ...
 // ADDING ALL MOBILE GAMES
  function addGamesAll99(theGameName) {   
    ...
    $(eval(theGameName7)).each(function(index, value) {
      ...
      if(jQuery.inArray(value.aLink, listy) != -1) {
        ...
        //<div class="greent1"> <img src="https://uploads-ssl.webflow.com/6262a56df551ed5332d9048e/633ad8a7b5d7fa7110f20b10_tickgreen.png"> </div>
