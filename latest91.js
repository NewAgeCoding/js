    ...
    if(v.id == the_id) {
      ...
      $('.replacediv').html(`
        ...
        height: 200px;">
            ...
            <img class="move" src="${v.iconz}" style="    width:77px;
            height: 77px;
            position: relative;
            top: -175px;
            left: -140px;" >
                    ...
                    background: transparent;"> 
                                 ...
                                 <h1 id="t1" class=" move" class="fontzzzy" style="margin-top: 0;">${v.name}</h1>
                     <h2 class="fontzzzy2 move" >${v.genre}</h2>
                       <p id="p1" class="move" style="width:300px;">${v.para}</p>
                </div> 
