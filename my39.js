...
//Mousemove / touchmove
genre_array = ["arcade-blocky", "casual-blocky", "fighting-blocky", "platform-blocky", "puzzle-blocky", "racing-blocky", "rpg-blocky", "sports-blocky", "strategy-blocky",
"fps-blocky", "tactics-blocky", "card-blocky", "sim-blocky", "pvp-blocky", "roguelike-blocky", "runner-blocky", "match-3-blocky"]

clicked_genre_array = genre_array[1]
  ...
  if (isSwiped) {
    ...
    if (Math.abs(diffY) > Math.abs(diffX)) {
      ...
      if(diffX > 100) {
        ...
        $("."+clicked_genre_array).show("slide", { direction: "left" }, 300);
      ...
      if (diffX < -100 ) {
        ...
        // Add proper genre to show
        $("."+clicked_genre_array).show("slide", { direction: "right" }, 300);

      }
      output.innerText = diffX > 0 ? "go Right" : "go Left";
    }
  }
});
