...
function changesplash(get_texty) {
	...
	$(this).find(".special1").css("color", "white")
	$(this).find(".pp99").css("color", "white")
	$(this).find(".paragraph-40").css("color", "white")
	...
	if(get_texty == "Diablo Immortal"){
		...
		$(this).find(".golong1").css("background", "red")
		...
		// Change background color depending on score
		$(this).find(".golong1").css("background", "purple")
