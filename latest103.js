...
<div class="glitch fade-in-left2" style="height: 175px; border: 2px solid;">
  ...
  $.each(array_gamez, function(i, v){
    if(v.id == the_id) {
      ...
      console.log(v.id, v.name, v.genre, v.para)
      // $("#t1").text(v.namez)
      ...
      $('.replacediv').html(`
        ...
        height: 200px;">
                    ...
                    background: transparent;"> 
                                 ...
                                 <h1 id="t1" class=" move" class="fontzzzy" style="    margin-top: 0;
                                 margin-left: -64px;
                                 float: left;
                                 width: 300px;
                                 position: relative;
                                 left: -55px;
                                 margin-bottom: -6px;">${v.name} <span style="    font-size: 11px;
                                 font-weight: normal;
                                 color: grey;">(${v.genre})</span></h1>
                    

                       <p id="p1" class="move" style="width:300px; margin-top: 27px;">${v.para}</p>
                </div> 
    ...
    `)
      ...
      $('.allpages').css("margin-top", "75px")
      return false
    }
  })
 // <h2 class="fontzzzy2 move" >${v.genre}</h2>



$('.whiteheading1').attr('style', 'color: black !important');
$(this).find(".whiteheading1").attr('style', 'color: blue !important');
